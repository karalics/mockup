 ...
 *
 * Example: example-1
 *    <div class="pat-wbcockpit"
 *         data-pat-wbcockpit="vocabularyUrl:/relateditems-test.json;
 *                             uploadUrl:/upload;
 *                             moveUrl:/moveitem;
...
define([
  ...
  'underscore',
  'pat-base',
  'mockup-patterns-wbcockpit-url/js/views/app'
], function($, _, Base, AppView) {
  'use strict';

  var WBcockpit = Base.extend({
    name: 'wbcockpit',
    trigger: '.pat-wbcockpit',
    parser: 'mockup',
    defaults: {
      ...
      menuGenerator: 'mockup-patterns-wbcockpit-url/js/actionmenu',
      ...
      */
      ...
      _default_tableRowItemAction: {
        folder: ['mockup-patterns-wbcockpit-url/js/navigation', 'folderClicked'],
        other: []
      },
