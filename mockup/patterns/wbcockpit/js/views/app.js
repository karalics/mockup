define([
  ...
  'mockup-patterns-wbcockpit-url/js/views/table',
  'mockup-patterns-wbcockpit-url/js/views/selectionwell',
  'mockup-patterns-wbcockpit-url/js/views/generic-popover',
  'mockup-patterns-wbcockpit-url/js/views/rearrange',
  'mockup-patterns-wbcockpit-url/js/views/selectionbutton',
  'mockup-patterns-wbcockpit-url/js/views/paging',
  'mockup-patterns-wbcockpit-url/js/views/columns',
  'mockup-patterns-wbcockpit-url/js/views/textfilter',
  'mockup-patterns-wbcockpit-url/js/views/upload',
  'mockup-patterns-wbcockpit-url/js/collections/result',
  'mockup-patterns-wbcockpit-url/js/collections/selected',
  'mockup-utils',
  'translate',
  'pat-logger',
  'jquery.cookie'
  ...
  var log = logger.getLogger('pat-wbcockpit');
  ...
  var AppView = BaseView.extend({
    ...
    initialize: function(options) {
      ...
      self.collection.on('pager', function() {
        ...
        } else if (self.options.urlWBcockpit) {
          // fallback to urlWBcockpit specification
          url = self.options.urlWBcockpit.base + path + self.options.urlWBcockpit.appended;
          window.history.pushState(null, null, url);
        }
        ...
        $('body').trigger('wbcockpit-url-changed', path);

      });

      if ((self.options.pushStateUrl || self.options.urlWBcockpit) && utils.featureSupport.history()) {
        $(window).bind('popstate', function() {
          ...
          if (self.options.pushStateUrl) {
            ...
            base = self.options.urlWBcockpit.base;
            appended = self.options.urlWBcockpit.appended;
          }
