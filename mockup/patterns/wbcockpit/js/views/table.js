define([
  'jquery',
  'underscore',
  'mockup-patterns-wbcockpit-url/js/views/tablerow',
  'text!mockup-patterns-wbcockpit-url/templates/table.xml',
  'mockup-ui-url/views/base',
  'mockup-patterns-sortable',
  'mockup-patterns-moment',
  'mockup-patterns-wbcockpit-url/js/models/result',
  'mockup-patterns-wbcockpit-url/js/views/actionmenu',
  'translate',
  'bootstrap-alert'
    ...
    addReordering: function() {
      ...
      var dd = new Sortable(self.$('tbody'), {
        ...
        createDragItem: function(pattern, $el) {
          ...
          $table.addClass('wbcockpit-dragging')
